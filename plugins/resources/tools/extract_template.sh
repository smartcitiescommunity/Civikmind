...
xgettext *.php */*.php */*/*.php --copyright-holder='Resources Development Team' --package-name='GLPI - Resources plugin' --package-version='2.4.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
