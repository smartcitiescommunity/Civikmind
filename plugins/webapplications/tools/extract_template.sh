...
xgettext *.php */*.php --copyright-holder='Webapplications Development Team' --package-name='GLPI - Webapplications plugin' --package-version='2.4.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
