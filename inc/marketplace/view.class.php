...
HTML;
   ...
   static function showFeatureSwitchDialog() {
      ...
      if (Controller::getPluginPageConfig() == Controller::MP_REPLACE_ASK
         ...
         echo "<br><br>";
         echo __("Civikmind Entrega 50 Plugins compatibles y no es necesario el nuevo marketplace para descargar e instalar plugins.");
         echo "<br><br>";
         echo "<b>".__("Deseas el sistema de Marketplace para tus plugins? Te sugerimos dar click en no")."</b>";
         echo "<hr><br>";
         echo Html::submit("<i class='fa fa-check'></i>&nbsp;".__('No'), [
            'name' => 'marketplace_replace_plugins_later'
         ]);
         echo "&nbsp;";
         echo Html::submit("<i class='fa fa-times'></i>&nbsp;".__('Yes'), [
