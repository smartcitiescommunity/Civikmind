...
(function() {
   ...
   $constants = [
      ...
      'GLPI_MARKETPLACE_DIR' => GLPI_ROOT . '/plugins', // Path for marketplace plugins
      ...
      'GLPI_ALLOW_IFRAME_IN_RICH_TEXT' => true,
      ...
      'GLPI_MARKETPLACE_ALLOW_OVERRIDE'   => false, // allow marketplace to override a plugin found outside GLPI_MARKETPLACE_DIR
